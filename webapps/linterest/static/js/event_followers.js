function populateList() {
    ...
    $.get("/linterest/get_event_followers/" + list.attr('event_id'))
      .done(function(data) {
...
function likeBack(username){
    console.log("like back " + username)
    var event_id = $('.gallery').attr('event_id');
    console.log(event_id);
    // save the user to the follower list and send the notification email
    $.post("/linterest/likeBack/" + username + "/" + event_id, {})
      .done(function(data) {
		  console.log('pair success and prepare to send email');
		  window.location.replace("/linterest/recommendations/" + event_id);
      });
}
